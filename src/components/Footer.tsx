        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400">
              Services électriques professionnels pour tous vos projets résidentiels et commerciaux.
            </p>
          </div>
            ...
            <ul className="space-y-2">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-gray-400 hover:text-revolt-red transition-colors duration-200"
                  >
                    {link.label}
                  </Link>
                </li>
